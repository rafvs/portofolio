...
const SpecularButton = ({
  ...
  // Keep the latest props available to the rAF loop without re-running the
  // WebGL setup effect. Updated after render (not during) to satisfy the
  // no-ref-writes-in-render rule.
  useEffect(() => {
